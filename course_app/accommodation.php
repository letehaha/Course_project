	...
	<div class="accommodation-forms">
		...
		<form class="form accommodation-form" id="accommodation-form">
			...
			<div class="form client-form js-client-form">
				...
				<div class="form-wrapper">
					<input type="text" autocomplete="off" required name="fname" placeholder="Имя" class="form-wrapper_child">
					<input type="text" autocomplete="off" required name="sname" placeholder="Фамилия" class="form-wrapper_child">
					<input type="text" autocomplete="off" required name="mname" placeholder="Отчество" class="form-wrapper_child">
				</div>

				<div class="form-wrapper">
					<input type="text" autocomplete="off" required name="passport" placeholder="Паспорт" class="form-wrapper_child">
					<input type="text" autocomplete="off" required name="tel" placeholder="Телефон" class="form-wrapper_child">
				</div>

				<div class="form-wrapper">
					<input type="text" autocomplete="off" required name="email" placeholder="email" class="form-wrapper_child">
					<input type="text" autocomplete="off" required name="country" placeholder="Страна" class="form-wrapper_child">
				</div>
